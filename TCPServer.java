...
public class TCPServer extends Thread {
	...
	public void run() {
		...
		try {
			...
			final OutputStreamWriter out = new OutputStreamWriter(sock.getOutputStream());
			...
			/*
			 * SAMPLE INPUT
			 * GOSSIP:mBHL7IKilvdcOFKR03ASvBNX//ypQkTRUvilYmB1/OY=:2017-01-09-16
			 * -18-20-001Z:GOSSIP% PEER:John:PORT=2356:IP=163.118.239.68%
			 *
			 */
			...
			while (true) {
				...
				if (toProcess.contains("GOSSIP:")) {
					...
					if (ips != null) {
						...
						final UDPBroadcast bc = new UDPBroadcast(sock.getPort(), toProcess, ips, ports);
						bc.broadCast();
				...
				if (isGossip) {
					...
					// Encode all the peers, the client will handle the decoding
					// and formatting
